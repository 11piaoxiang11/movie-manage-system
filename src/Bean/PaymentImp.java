...
public class PaymentImp implements Serializable {
    ...
    public PaymentImp(Integer id, String userName, String PaymentAmount, String movieName, String times, String room, String tickingTime) {
        this.id = id;
        this.userName = userName;
        this.PaymentAmount = PaymentAmount;
        this.movieName = movieName;
    ...
    public PaymentImp(Integer id, String userName, String PaymentAmount, String movieName, String times, String room, String tickingTime, String count) {
        this.id = id;
        this.userName = userName;
        this.PaymentAmount = PaymentAmount;
        this.movieName = movieName;
